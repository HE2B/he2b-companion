...
import { NewsType, SportNews } from "../../model/news";
import { useAppStore } from "../../store";

export default function NewsSport({ news }: NewsSportProps) {
		...
		<>
			<Card style={{
				...
				<div style={{ flex: 1, padding: "10px" }}>
					<p style={{ fontSize: 9, color: "gray" }}>{NewsType.SPORT.toUpperCase()}</p>
...
export interface NewsSportProps {
	news: SportNews;
}
